...
function press(button) { //function routing for both mouse and keyboard input
    switch (button) {
        ...
        case "1/x": button_1x(); flash("inverse"); break;
        case "MC": button_mc(); flash("mc"); break;
        case "M+": button_mplus(); flash("mplus"); break;
        case "M-": button_mminus(); flash("mminus"); break;
        case "MR": button_mr(); flash("mr"); break;
        case "/": button_divide(); flash("divide"); break;
        case "x": button_multiply(); flash("multiply"); break;
        case "-": button_subtract(); flash("subtract"); break;
        case "+": button_add(); flash("add"); break;
...
document.onkeyup = function(e) { //keyboard functionality
    switch (e.which) {
        ...
        case 98: press('2'); break;
        case 51: press('3'); break;
        case 99: press('3'); break;
        case 52: press('4'); break;
        case 100: press('4'); break;
        case 53: press('5'); break;
        case 101: press('5'); break;
        case 54: press('6'); break;
        case 102: press('6'); break;
        case 55: press('7'); break;
        case 103: press('7'); break;
        case 56: press('8'); break;
        case 104: press('8'); break;
        case 57: press('9'); break;
        case 105: press('9'); break;
        case 48: press('0'); break;
        case 96: press('0'); break;
        case 190: press('.'); break;
        case 110: press('.'); break;
        case 65: press("AC"); break;
        case 67: press("AC"); break;
        case 46: press("Del"); break;
        case 83: press("1/x"); break;
        case 81: press("MC"); break;
        case 87: press("M+"); break;
        case 69: press("M-"); break;
        case 82: press("MR"); break;
        case 19: press("/"); break;
        case 111: press("/"); break;
        case 88: press("x"); break;
        case 106: press("x"); break;
